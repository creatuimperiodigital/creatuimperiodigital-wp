...
<div class="dashboard-content">
   ...
   <div class="main-content">
      <div>
         <h3><?php echo __("Ninja Forms connected with Google Sheet", "gsheetconnector-njforms"); ?></h3>
            ...
            if (!empty($forms_list)) {
               foreach ($forms_list as $key => $value) {
                  ...
                  if ($value->title !== "") {
                     ...
                     <?php } else {
                     ?>
                     <li><span><?php echo __("No Ninja Forms are connected with google sheet.", "gsheetconnector-njforms"); ?></span></li>
                     <?php
                  }
               }
            } else {
