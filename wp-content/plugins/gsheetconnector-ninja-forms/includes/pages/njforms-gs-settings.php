...
<div class="wrap">
   <?php
   $tabs = array(
       'integration'    => __('Integration', 'gsheetconnector-njforms'),
       'faq'            => __('FAQ', 'gsheetconnector-njforms'),
       'demos'          => __('Demos', 'gsheetconnector-njforms'),
       'system_status'  => __('System Status', 'gsheetconnector-njforms'),
       //'system_status'  => __('System Status', 'gsheetconnector-njforms'),
   );
